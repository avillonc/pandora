...
export const lengthValidator = (value, length) => {
  ...
  return value.length == length || `Este campo debe contener ${length} caracter(es)`
}
...
export const minlengthValidator = (value, length) => {
  ...
  return value.length >= length || `Este campo debe contener mínimo ${length} caracter(es)`
}
...
export const maxlengthValidator = (value, length) => {
  ...
  return value.length <= length || `Este campo debe contener máximo ${length} caracter(es)`
}
